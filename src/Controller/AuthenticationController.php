...
use PhpSample\Model\Validator\LoginValidator;
        ...
        if ($request->getMethod() === 'POST') {
            if ($validator->check($request)) {
                ...
                if (
                    ...
                    return $this->redirectResponse($this->sessionService->get(['previousNotAllowedPath'], true)['previousNotAllowedPath'] ?? '/file');
                }
